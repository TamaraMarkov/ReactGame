...
const XmixDrix: FC = () => {
  ...
  const checkWin = () => {
    ...
    } else if (bricks[0].state != 0 && bricks[0].state == bricks[1].state && bricks[0].state == bricks[2].state) {
      winner = bricks[0].state
    }
    if (bricks[3].state != 0 && bricks[3].state == bricks[4].state && bricks[3].state == bricks[5].state) {
      console.log("game over 1")
      winner = bricks[3].state
    } else if (bricks[3].state != 0 && bricks[3].state == bricks[4].state && bricks[3].state == bricks[5].state) {
      winner = bricks[3].state
    }
    if (bricks[6].state != 0 && bricks[6].state == bricks[7].state && bricks[6].state == bricks[8].state) {
      console.log("game over 1")
      winner = bricks[6].state
    } else if (bricks[6].state != 0 && bricks[6].state == bricks[7].state && bricks[6].state == bricks[8].state) {
      winner = bricks[6].state
    }
    if (bricks[0].state != 0 && bricks[0].state == bricks[3].state && bricks[0].state == bricks[6].state) {
      console.log("game over 1")
      winner = bricks[0].state
    } else if (bricks[0].state != 0 && bricks[0].state == bricks[3].state && bricks[0].state == bricks[6].state) {
      winner = bricks[0].state
    }
    if (bricks[1].state != 0 && bricks[1].state == bricks[4].state && bricks[1].state == bricks[7].state) {
      console.log("game over 1")
      winner = bricks[1].state
    } else if (bricks[1].state != 0 && bricks[1].state == bricks[4].state && bricks[1].state == bricks[7].state) {
      winner = bricks[1].state
    }
    if (bricks[2].state != 0 && bricks[2].state == bricks[5].state && bricks[2].state == bricks[8].state) {
      console.log("game over 1")
      winner = bricks[2].state
    } else if (bricks[2].state != 0 && bricks[2].state == bricks[5].state && bricks[2].state == bricks[8].state) {
      winner = bricks[2].state
    }
    if (bricks[2].state != 0 && bricks[2].state == bricks[4].state && bricks[2].state == bricks[6].state) {
      console.log("game over 1")
      winner = bricks[2].state
    } else if (bricks[2].state != 0 && bricks[2].state == bricks[4].state && bricks[2].state == bricks[6].state) {
      winner = bricks[2].state
    }
    if (bricks[0].state != 0 && bricks[0].state == bricks[4].state && bricks[0].state == bricks[8].state) {
      console.log("game over 1")
      winner = bricks[0].state
    } else if (bricks[0].state != 0 && bricks[0].state == bricks[4].state && bricks[0].state == bricks[8].state) {
      winner = bricks[0].state
    }
    console.log("no win")
    if (winner > 0) {
    ...
    <View style={styles.container} >
      ...
      <View style={styles.buttons_container}>
        <TouchableOpacity style={styles.button}
          onPress={restart}>
          <Text style={{ fontSize: 20 ,fontWeight:"bold"}}>Restart</Text>
        </TouchableOpacity>
      </View>
    </View >
  );
